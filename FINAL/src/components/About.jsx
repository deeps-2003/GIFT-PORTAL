  ...
  return (
    ...
    <div className="about-container">
      <div className="about-content">
        <h1>About Us</h1>
        <p>
          Welcome to Gift Cart, your go-to destination for creating unforgettable moments through personalized gifts. Our journey began with a simple idea: to transform the act of gift-giving into a meaningful experience.
        </p>
        <p>
